:: ===========================================================================
:: Nom       : DetectFirmware.bat
:: Projet    : WinMigrate
:: Author    : PS81FRT
:: GitHub    : https://github.com/ps81frt/winmigrate
:: Version   : 1.0.0
:: Licence   : MIT
:: Synopsis  : Detect firmware type (UEFI or Legacy BIOS) via bcdedit
...
:ADMIN_OK
set "FW_TYPE=BIOS (Legacy)"
bcdedit | find /i ".efi" >nul 2>&1
if %errorlevel%==0 set "FW_TYPE=UEFI"
if /i "%WINMIGRATE_LANG%"=="FR" (
    echo Type de firmware : %FW_TYPE%
) else (
